...
Git:
    ...
    git clone https://github.com/cucumber/cucumber-java-steps.git
    cd cucumber-java-steps

Subversion:

    svn checkout https://github.com/cucumber/cucumber-java-steps
    cd cucumber-java-steps

Or simply [download](https://github.com/cucumber/cucumber-java-steps/releases) a zip or tarball.
...
Specify a particular scenario by *line* (and use the pretty format)
    ...
    -Dcucumber.options="classpath:steps/belly.feature:4 --format pretty"

This works because Maven puts `./src/test/resources` on your `classpath`.
You can also specify files to run by filesystem path:

    -Dcucumber.options="src/test/resources/steps/belly.feature:4 --format pretty"
